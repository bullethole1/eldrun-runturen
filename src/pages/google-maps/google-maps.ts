...
export class GoogleMapsPage {
    ...
    showMap(){
        //Location lat long
        var locations = [
            ['Fredriksdal', 58.9644444, 17.4625, "Här är texten1",[
            ...
            ['Kristinedal(sö37) 2(2)', 58.97, 17.425555555555558, "Här är texten2",[
            ...
            ['Norastenen(sö30) 1(2)', 58.9661111, 17.541111111111114, "Här är texten3",[
            ...
            ['Tjuvstigen v(sö34) 2(2)', 58.9777778, 17.54527777777778, "Här är texten4",[
            ...
            ['Långbro(sö25) 1(3)', 58.9286111, 17.477777777777778, "Här är texten5",[
            ...
            ['Skåängstenen (sö32) 1(2)', 58.9638889, 17.43138888888889, "Här är texten6",[
            ...
            ['Bergastenen nr 1(sö24) 1(2)', 58.9363889, 17.498611111111114, "Här är texten7",[
            ...
            ['Västerljungkyrka', 58.9219444, 17.448888888888888,"Här är texten8", [
            ...
            ['Björke', 58.9241667, 17.459166666666665, "Här är texten9", [
            ...
            ['Erikslund Gillberga (sö42)', 58.9161111, 17.450833333333332,"Här är texten10", [
        ...
        google.maps.event.addListener(marker, 'click', (
            ...
            infowindow.setContent("<img src='" + locations[i][4][0] + "' id='rune" + i + "'>");
